...
Mdl = fitcecoc(TrainData, TrainLabel, 'Learners', templateSVM('KernelFunction', 'polynomial', 'PolynomialOrder', 2, 'KernelScale', 'auto', 'BoxConstraint', 1), 'Coding', 'onevsall', 'ClassNames', [0 1 2 3]);
